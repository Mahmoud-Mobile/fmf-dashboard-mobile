...
const EventCardList = ({ item, onPress, width }) => {
  return (
    <TouchableOpacity
      activeOpacity={0.85}
      onPress={() => onPress?.(item)}
      style={[styles.cardContainer, styles.listCard, width ? { width } : null]}
    >
      ...
      <View style={styles.cardFooter}>
        <View style={styles.footerMeta}>
          <Text style={styles.attendeeText}>{item?.attendeeCount}</Text>
