          ...
          {remainingItems.length > 0 && (
            <View style={styles.secondRow}>
              {remainingItems.map((item, index) => (
                <View key={`remaining-${index}`} style={styles.legendItem}>
                  <View
                    style={[
                      styles.legendColor,
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.chartContainer}>
        ...
        <View style={styles.legendSection}>{renderLegend()}</View>
      </View>
    </View>
  );
};

export default ReturnGuestChart;
